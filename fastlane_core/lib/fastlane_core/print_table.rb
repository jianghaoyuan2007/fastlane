module FastlaneCore
  class PrintTable
    class << self
      ...
      def print_values(config: nil, title: nil, hide_keys: [], mask_keys: [], transform: :truncate_middle)
        ...
        params = {}
        transform = false if Helper.is_ci? || Helper.is_test? || FastlaneCore::Env.truthy?("SKIP_TRANSFORM_TABLES")
